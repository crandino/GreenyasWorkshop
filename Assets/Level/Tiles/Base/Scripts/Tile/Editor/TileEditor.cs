...
public class TileEditor : Editor
{
    ...
    protected virtual int NodesPerPath => 2;
    ...
    public override void OnInspectorGUI()
    {
        ...
        props.pathsArray.ChangeArraySizeAndInitialize<TilePath>(EditorGUILayout.DelayedIntField(props.pathsArray.arraySize), NodesPerPath);
    ...
    private struct Properties
    {
        ...
        public Properties(SerializedObject @object)
        {
            ...
            for (int i = 0; i < paths.Length; i++)
            {
                ...
                paths[i].nodes = new PathProperties.NodeProperties[nodes.arraySize];
